...
const gStyles = {
    ...
    card:       { background: "#222", border: "1px solid #2e2e2e", borderRadius: "8px", overflow: "hidden", cursor: "pointer" },
            ...
            <div style={gStyles.column}>
                ...
                <div style={gStyles.grid}>
                    ...
                    {blogGroups && blogGroups.map((group) => (
                        ...
                        >
                            {group.coverImage ? (
                                <img src={`${backendUrl}/uploads/${group.coverImage}`} alt={group.name} style={gStyles.cardImage} />
                            ) : (
                            ...
                            <div style={gStyles.cardBody}>
                                ...
                                <p style={gStyles.cardDesc}>{group.description || "No description"}</p>
