        ...
        <div style={styles.page}>
            <div style={styles.column}>
                ...
                <div style={styles.grid}>
                    {members.map(member => (
                        <MemberCard key={member._id} member={member} onClick={() => setSelected(member)} />
                    ))}
                </div>
            </div>
                ...
                <div style={styles.modalBackdrop} onClick={() => setSelected(null)}>
                    <div style={styles.modal} onClick={e => e.stopPropagation()}>
                        ...
                        <div style={styles.modalField}>
                            ...
                            <a href={`mailto:${selected.email}`} style={styles.modalFieldValue}>{selected.email}</a>
                        </div>
                        {selected.link && (
                            <div style={styles.modalField}>
...
const styles = {
    ...
    cardHint:        { fontFamily: "'Courier New', monospace", fontSize: "8px", color: "#fa4040", letterSpacing: "2px", margin: "10px 0 0 0", transition: "opacity 0.2s ease" },
    ...
    modalDivider:    { width: "100%", height: "1px", background: "#2a2a2a", margin: "20px 0" },
